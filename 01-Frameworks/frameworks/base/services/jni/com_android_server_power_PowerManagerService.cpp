...
bool android_server_PowerManagerService_isMouseMode() {
    AutoMutex _l(gPowerManagerLock);
	return gMouseMode;
}
...
static void nativeSetMouseMode(JNIEnv *env, jclass clazz, jboolean enable) {
	gMouseMode = enable;	
}
...
static JNINativeMethod gPowerManagerServiceMethods[] = {
    ...
    { "nativeSetMouseMode", "(Z)V",
            (void*) nativeSetMouseMode },
};
