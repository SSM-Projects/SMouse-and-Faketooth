...
// Faketooth
static jint
android_media_AudioSystem_setBluetoothSelectedHost(JNIEnv *env, jobject clazz, jint selectedHost)
{
    return (jint) AudioSystem::setBluetoothSelectedHost((int) selectedHost);
}
...
static JNINativeMethod gMethods[] = {
    ...
    {"setBluetoothSelectedHost",    "(I)I", (void *)android_media_AudioSystem_setBluetoothSelectedHost}, // Faketooth
};
