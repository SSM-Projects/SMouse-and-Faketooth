...
import com.android.systemui.statusbar.policy.MouseController;
...
class QuickSettings {
    ...
    void setup(NetworkController networkController, BluetoothController bluetoothController,
            ...
            RotationLockController rotationLockController, MouseController mouseController) {
		...
		mouseController.addStateChangedCallback(mModel);
    ...
    private void addSystemTiles(ViewGroup parent, LayoutInflater inflater) {
        ...
        final QuickSettingsBasicTile mouseTile
                = new QuickSettingsBasicTile(mContext);

        mModel.addMouseModeTile(mouseTile, new QuickSettingsModel.RefreshCallback() {
            @Override
            public void refreshView(QuickSettingsTileView unused, State state) {
                mouseTile.setImageResource(state.iconId);

                String mouseState = mContext.getString(
                        (state.enabled) ? R.string.accessibility_desc_on
										: R.string.accessibility_desc_off);

                mouseTile.setContentDescription(
                        mContext.getString(R.string.accessibility_quick_settings_mouse, mouseState));
                mouseTile.setText(state.label);
            }
        });

        parent.addView(mouseTile);
