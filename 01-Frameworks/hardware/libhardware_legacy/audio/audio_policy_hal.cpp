...
// Faketooth
static int ap_set_bluetooth_selected_host(const struct audio_policy *pol,
                                          int selectedHost)
{
    const struct legacy_audio_policy *lap = to_clap(pol);
    lap->apm->setBluetoothSelectedHost(selectedHost);
    return 1;
}
                            ...
                            struct audio_policy **ap)
{
    ...
    lap->policy.set_bluetooth_selected_host = ap_set_bluetooth_selected_host; // Faketooth
