...
AudioPolicyManagerBase::AudioPolicyManagerBase(AudioPolicyClientInterface *clientInterface)
    ...
    Thread(false),
#endif //AUDIO_POLICY_TEST
    mBluetoothSelectedHost(0), // Faketooth
...
AudioPolicyManagerBase::routing_strategy AudioPolicyManagerBase::getStrategy(
    ...
    case AudioSystem::FAKETOOTH: // Faketooth
        return STRATEGY_FAKETOOTH;
    }
}

// Faketooth
void AudioPolicyManagerBase::setBluetoothSelectedHost(int32_t selectedHost) {
                                            ...
                                            audio_devices_t device)
{
	...
	// Faketooth
    if (stream == AudioSystem::FAKETOOTH)
        return 1.0;
