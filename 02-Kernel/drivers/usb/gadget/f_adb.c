...
static struct usb_request *adb_request_new(struct usb_ep *ep, int buffer_size)
{
	...
	printk(KERN_INFO "**************************************************** adb_request_new\n");
	if (!req)
		return NULL;
...
{
	printk(KERN_INFO "**************************************************** adb_request_free\n");
	if (req) {
		kfree(req->buf);
		usb_ep_free_request(ep, req);
	}
...
//	printk(KERN_INFO "**************************************************** adb_complete_in\n");
...
{
	struct adb_dev *dev = _adb_dev;
//	printk(KERN_INFO "**************************************************** adb_complete_out\n");
				...
				struct usb_endpoint_descriptor *out_desc)
{
	...
	struct usb_ep *ep;
	int i;
	printk(KERN_INFO "**************************************************** adb_create_bulk_endpoints\n");
